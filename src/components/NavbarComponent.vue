  ...
  <div class="flex w-full flex-wrap items-center justify-between px-3">
    ...
    <div
      ...
      <a
        ...
        href="#">
        <img
          src="https://img.freepik.com/free-vector/font-design-word-organic-with-many-vegetables-basket_1308-42285.jpg?size=626&ext=jpg&ga=GA1.2.1506769116.1690802231&semt=ais"
          style="height: 15px"
          alt="TE Logo"
          loading="lazy" />
      </a>
      ...
      <ul
        ...
        <li class="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
          ...
          <a
            ...
            ><router-link :class="{active:rl_1}" to="/">Home</router-link></a
          >
        </li>
        <!-- Team link -->
        <li class="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
          <a
            ...
            href="#"
            data-te-nav-link-ref
            ><router-link :class="{active:rl_4}" to="/produk">Produk</router-link></a
          >
        </li>
        <li class="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
          <a
            ...
            href="#"
            data-te-nav-link-ref
            ><router-link :class="{active:rl_5}" to="/kategori">Kategori</router-link></a
          >
        </li>
      </ul>
    </div>
