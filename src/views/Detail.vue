<template>
  ...
  <div class="container flex items-center px-6 py-12 mx-auto">
      <div class="flex flex-col items-center max-w-sm mx-auto text-center">
          <p class="p-3 text-sm font-medium text-red-500 rounded-full bg-red-100 dark:bg-gray-800">
          ...
          <div class="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
              ...
              <router-link to="/">
              <button class="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-red-500 rounded-lg shrink-0 sm:w-auto hover:bg-red-600 dark:hover:bg-red-500 dark:bg-red-600">
                  Take me home
              </button>
          </router-link>
          </div>
              ...
              <div class="w-full px-4 md:w-1/2 ">
                  <div class="sticky top-0 z-50 overflow-hidden ">
                      <div class="relative mb-6 lg:mb-10" style="height:450px;">
                        <img src="https://img.freepik.com/free-photo/spring-wardrobe-switch-still-life_23-2150176694.jpg?size=626&ext=jpg&ga=GA1.1.1506769116.1690802231&semt=ais"
                                alt="" class="object-contain w-full h-full ">
                      </div>
                      <div class="flex-wrap hidden md:flex ">
                          <div class="w-1/2 p-2 sm:w-1/4">
                              <a href="#"
                                  class="block border border-pink-100 dark:border-gray-700 dark:hover:border-gray-600 hover:border-pink-300 ">
                                  <img src="https://img.freepik.com/free-photo/spring-wardrobe-switch-still-life_23-2150176694.jpg?size=626&ext=jpg&ga=GA1.1.1506769116.1690802231&semt=ais"
                          ...
                          <div class="w-1/2 p-2 sm:w-1/4">
                              <a href="#"
                                  class="block border border-pink-100 dark:border-transparent dark:hover:border-gray-600 hover:border-pink-300">
                                  <img src="https://img.freepik.com/free-photo/spring-wardrobe-switch-still-life_23-2150176694.jpg?size=626&ext=jpg&ga=GA1.1.1506769116.1690802231&semt=ais"
                                        alt="" class="object-cover w-full lg:h-32">
                              </a>
                          </div>
              ...
              <div class="w-full px-4 md:w-1/2 ">
                  <div class="lg:pl-20">
                      <div class="pb-6 mb-8 border-b border-gray-200 dark:border-gray-700">
                          ...
                          <div class="p-4 mb-8 border border-gray-300 dark:border-gray-700">
                              <h2 class="mb-4 text-xl font-semibold dark:text-gray-400">Real time <span
                                      class="px-2 bg-pink-500 text-gray-50">26</span>
                              ...
                              <div class="w-full bg-gray-200 rounded-full h-2.5  dark:bg-gray-600">
                                  <div class="bg-pink-600 dark:bg-pink-400 h-2.5 rounded-full" style="width:45%;">
                                  </div>
                              </div>
                          </div>
                      ...
                      <div class="pb-6 mb-8 border-b border-gray-300 dark:border-gray-700">
                          ...
                          <div class="flex flex-wrap -mb-2">
                              <button
                                  class="py-1 mb-2 mr-1 border w-11 hover:border-pink-400 dark:border-gray-400 hover:text-pink-600 dark:hover:border-gray-300 dark:text-gray-400">XL
                              </button>
                              <button
                                  class="py-1 mb-2 mr-1 border w-11 hover:border-pink-400 hover:text-pink-600 dark:border-gray-400 dark:hover:border-gray-300 dark:text-gray-400">S
                              </button>
                              <button
                                  class="py-1 mb-2 mr-1 border w-11 hover:border-pink-400 hover:text-pink-600 dark:border-gray-400 dark:hover:border-gray-300 dark:text-gray-400">M
                              </button>
                              <button
                                  class="py-1 mb-2 mr-1 border w-11 hover:border-pink-400 hover:text-pink-600 dark:border-gray-400 dark:hover:border-gray-300 dark:text-gray-400">XS
                              </button>
                          </div>
                      </div>
                      <div class="flex flex-wrap items-center ">
                          ...
                          <div class="mb-4 mr-4 lg:mb-0">
                            <router-link to="/kategori">
                              <button
                                  class="w-full h-10 p-2 mr-4 bg-pink-500 dark:text-gray-200 text-gray-50 hover:bg-pink-600 dark:bg-pink-600 dark:hover:bg-pink-500">
                                  Buy Now</button></router-link>
                          </div>
                          <div class="mb-4 mr-4 lg:mb-0">
                              <button
                                  class="flex items-center justify-center w-full h-10 p-2 text-gray-700 border border-gray-300 lg:w-11 hover:text-gray-50 dark:text-gray-200 dark:border-pink-600 hover:bg-pink-600 hover:border-pink-600 dark:bg-pink-600 dark:hover:bg-pink-500 dark:hover:border-pink-500 dark:hover:text-gray-300">
